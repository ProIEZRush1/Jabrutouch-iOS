...
class Strings {
    ...
    class var jabrutouch: String {
        return NSLocalizedString("jabrutouch", comment: "")
    }
    
    class var learnTalmudAndGemara: String {
        return NSLocalizedString("learnTalmudAndGemara", comment: "")
    }
    
    class var giveTheGiftOfLearning: String {
        return NSLocalizedString("giveTheGiftOfLearning", comment: "")
    }
    
    class var askTheRabbiJoinTheJabruta: String {
        return NSLocalizedString("askTheRabbiJoinTheJabruta", comment: "")
    }
    
    class var signIn: String {
        return NSLocalizedString("signIn", comment: "")
    }
    
    class var emailOrPhoneNumber: String {
        return NSLocalizedString("emailOrPhoneNumber", comment: "")
    }
    ...
    class var signUp: String {
        return NSLocalizedString("signUp", comment: "")
    }
