...
std::unique_ptr<BundleElement> BundleReader::DecodeBundleElementFromBuffer() {
  ...
  if (json_object.contains("metadata")) {
    return std::make_unique<BundleMetadata>(serializer_.DecodeBundleMetadata(
