...
//  Jabrutouch
//
//  Created by AviDeutsch on 27/01/2020.
...
class SKRecordView: UIView, AVAudioPlayerDelegate, AVAudioRecorderDelegate {
    ...
    var normalImage = UIImage(named: "mic")!
    var recordingImages = [UIImage(named: "mic")!,UIImage(named: "mic")!,UIImage(named: "mic")!,UIImage(named: "mic")!,UIImage(named: "mic")!,UIImage(named: "mic")!]
