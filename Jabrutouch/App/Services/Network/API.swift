...
class API {
    ...
    class func signUp(userId: String, firstName:String, lastName:String, phoneNumber: String, email: String, password:String, fcmToken: String, completionHandler:@escaping (_ response: APIResult<SignUpResponse>)->Void) {
